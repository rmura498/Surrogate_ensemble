...
# load models
victim_models = [load_model(victim, device=device) for victim in VICTIM_NAMES]
ens_surrogates = [load_model(surrogate, device=device) for surrogate in SURROGATE_NAMES]
