...
python run_attacks_ablation_alpha.py  --attack_type nPF --loss CW --victim swin_s --n_surrogates 10 --batch_size 100 --pool 2 --sw 40 --lmb 0.05 --eps 0 --device cuda:0 --pgd_iterations 100
