...
"""for i, victim in enumerate(victim_models):
    ...
    save_json(simlarity_dict_vict, f'{generate_time()}_{VICTIM_NAMES[i]}_sim_eval_b{batch_size}_')
    simlarity_dict_vict = {}
"""
for i, surr in enumerate(ens_surrogates):
    ...
    save_json(simlarity_dict_surr, f'{generate_time()}_{SURROGATE_NAMES[i]}_sim_eval_b{batch_size}_')
    simlarity_dict_surr = {}
